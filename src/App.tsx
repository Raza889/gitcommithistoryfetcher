        ...
        <div className="bg-gray-100 p-3 min-h-screen flex items-center justify-center">
            ...
            <div className="max-w-md p-4 bg-white rounded shadow-md">
                <form onSubmit={handleSubmit} className="card shadow-lg p-3 rounded mb-2">
                    <TextInput onChange={(e: any) => setOwnerName(e.target.value)} value={ownerName} label={"Owner Name"} placeHolder={"Owner name"} />
                    <TextInput onChange={(e: any) => setRepoName(e.target.value)} value={repoName} label={"Repo Name"} placeHolder={"Repo name"} />
